...
public class webSocketServer extends WebSocketServer {
    ...
    public void onOpen(WebSocket conn, ClientHandshake handshake) {
        if (!isConnected) {
            ...
            MinecraftClient.getInstance().player.sendMessage(Text.literal("作者不对使用此模组造成的人身伤害和精神伤害负责"), false);
            MinecraftClient.getInstance().player.sendMessage(Text.literal("使用此模组请自行注意人身安全"), false);
            MinecraftClient.getInstance().player.sendMessage(Text.literal("==="), false);
